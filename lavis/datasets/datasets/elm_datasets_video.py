...
class ELMDatasetVideo(VQADataset, __DisplMixin):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        ...
        self.default_nuscenes_video_ego_pose_sample()
        # self.default_codalm()
    ...
    def default_nuscenes_video_ego_pose_sample(self):
        sample_rate = 2
...
class ELMDatasetEvalDatasetVideo(VQADataset, __DisplMixin):
    def __init__(self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=None):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
        ann_root (string): directory to store the annotation file
